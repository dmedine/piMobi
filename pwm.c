// Adapted by David Medine at SCCN to be a shared object -- part of the
// piMobi project 
// The only modification is the commenting out of the main function
// Thanks to Chris Hager for this excellent open source software!
